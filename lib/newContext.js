...
module.exports = function _Context($$fetch, $$exec, $$global) {
  ...
  Dependency.prototype.loadModule = function loadModule(
    ...
    if (!modulePath)
      modulePath = (dependency.package && (dependency.package.main || dependency.package.module)) || "main";
    ...
    var promise = new Promise(async function loadModulePromise(resolve) {
      ...
      var $modulePath = modulePath || (dependency.package.main || dependency.package.module) || "main";
  ...
  function Context(id) {
    ...
    context.defineModule("pako", () => {
      return pako;
    });   
    context.defineModule("semver", () => {
      return semver;
    });
    context.defineModule("tar", () => {
      return tar;
    });
    context.defineModule("fetch", () => {
      return $$fetch;
    });    
    context.defineModule("zlib", () => {
      return zlib;
    });
