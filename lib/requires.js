(function (global, $$exec) {
  ...
  (function ($$events, $$crypto, $$path, $$util, $$url, $$buffer, fetch) {
    ...
    function makeContext(contextName) {
      ...
      mainRequire.install = async function (callback) {
        mainRequire.provider = u;
        mainRequire.home = u;
        return context.install(context.basePath, callback);
      };

      // for (var i in nodeDeps) {
      //   ((i) => {

      //     context.defineModule("node:"+i, function (require, exports, module, define) {
