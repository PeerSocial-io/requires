(function ($$global, $$exec, $$exec_VM) {
...
})(typeof global !== "undefined" ? global : this, function $eval(global, define /* context arguments[1] */ ) {
  try{
  eval(arguments[2]);
  }catch(err){
    console.error(err);
  ...
  var vm = require('vm');
  var context = vm.createContext({ global: global, define:define });  
